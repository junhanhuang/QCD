...
for (dataset in dataset_names) {
  ...
  cluster_file <- file.path(dataset_dir, "cluster_truth_labels.csv")
  ...
  png(file.path(dataset_dir, paste0(dataset, "_lineage_structure_truth.png")),
  ...
  plot(
    ...
    xlab = "PC1", ylab = "PC2"
  #  main = paste0(dataset, " | lineage_structure | truth ")
  )
  ...
  saveRDS(sce, file = file.path(dataset_dir, "slingshot_sce_truth.rds"))
  cat("  已保存 SCE 对象和轨迹图：slingshot_sce_truth.rds\n\n")
}
